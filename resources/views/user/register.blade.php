...
<div class="container-fluid">
    <div class="row align-items-center justify-content-center">
        <div class="col-12 col-md-5 col-lg-6 col-xl-4 px-lg-6 my-5">
            ...
            <!-- Form -->
            <form method="post" action="{{route ('regiter')}}">
                @csrf
                <!-- Email address -->
                <div class="form-group">
                    ...
                    <!-- Input -->
                        <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="请输入账户名">
                    <label>
                        邮箱
                    </label>

                    <!-- Input -->
                    <input type="email" value="1295727646@qq.com" name="email" class="form-control" placeholder="请输入邮箱">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" class="form-control form-control-appended" placeholder="请输入密码">
                </div>
                <div class="form-group">
                    <label>
                        验证码
        ...
        <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
            ...
            <!-- Image -->
            <div class="bg-cover vh-100 mt--1 mr--3" style="background-image: url({{asset ('org/Dashkit-1.1.2/asset')}}/img/covers/auth-side-cover.jpg);"></div>
